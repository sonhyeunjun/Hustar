...
<%
    ...
    {
        bbsID = Integer.parseInt(request.getParameter("noticeID"));
    }
    if (bbsID == 0)
    {
        PrintWriter script = response.getWriter();
			...
			<main>
				<div class="container-fluid px-4">
					...
					<div class="card mb-4">
						...
						<div class="container">
							<div class="row">
								<form method="post" action="updateAction.jsp?bbsID=<%=noticeID%>">
										...
										<tbody>
											<tr>
												<td><input type="text" class="form-control"
													...
													value="<%=notice.geNoticeTitle()%>"></td>
											</tr>
											<tr>
												<td><textarea class="form-control" placeholder="글 내용"
														name="bbsContent" maxlength="2048" style="height: 350px"><%=notice.getBbsContent()%></textarea></td>
											</tr>
										</tbody>
									</table>
